...
def main():
    set_seed(53)  # Setting the seed at the start of the main function

    select = input('Enter option number (Enter 1 to train the model, or 2 to test the model): ')

    base_path = '//ai'
    train_path = '//ai/training_data'
    test_path = '//ai/testing_data'
    predict_path = '//predict/'  # Added predict_path
    ...
    if select == '1':
        ...
        input_size = width * height  # Adjust based on your data
